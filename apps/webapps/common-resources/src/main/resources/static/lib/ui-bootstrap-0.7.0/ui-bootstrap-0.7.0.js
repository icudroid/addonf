...
.directive('collapse', ['$transition', function($transition) {
  ...
  // "collapse") then you trigger a change to height ui-bootstrap-0.7.0 in between.
...
function CarouselDemoCtrl($scope) {
  ...
  for (var i=ui-bootstrap-0.7.0; i<4; i++) $scope.addSlide();
}
  </file>
  <file name="demo.css">
    .carousel-indicators {
...
<example module="ui.bootstrap">
  <file name="index.html">
    <div ng-controller="TabsDemoCtrl">
      <button class="btn btn-small" ng-click="items[ui-bootstrap-0.7.0].active = true">
  ...
  <file name="script.js">
    function TabsDemoCtrl($scope) {
      $scope.items = [
        { title:"Dynamic Title 1", content:"Dynamic Item ui-bootstrap-0.7.0" },
